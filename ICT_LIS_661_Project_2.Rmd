...
Now that we've been introduced to `.Rmd` files, let's talk about what we're going to do with this one. In short, an `.Rmd` is a handy way for me to have you both show me your code and tell me about your code, all in the same document. Before moving on, please ensure that you have copied this file out of the GitHub repository where you found it and pasted it into a different folder before starting to make your own changes.
...
> What is your interest in this dataset? In general terms, what would you like to know about it? More specifically, what are some possible research questions that you could ask?
...
## Project 2, Part 2: Descriptive Statistics
...
> In the code chunk below, write code to list the variables included in the dataset. Then, below the code chunk, list and explain 5-10 of the most important variables.
